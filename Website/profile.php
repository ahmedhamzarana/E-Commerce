...
<style>
    ...
    .profile-card {
        box-shadow: 0 0 15px rgba(0, 0, 0, 0.1); /* Subtle Gray Shadow */
        border-radius: 12px;
    ...
    .status-badge {
        ...
        background-color: #343a40 !important; /* Dark gray/black for high contrast */
        color: #fff;
    }
    .card-header-bg {
        height: 100px;
        ...
        <div class="row g-0">
            ...
            <div class="col-md-4 border-end bg-white rounded-start">
                ...
                <div class="profile-image-container mt-n5">
                    ...
                    <img src="../Admin/assets/uploads/<?php echo $_SESSION['image']; ?>" 
                    ...
                    <div class="text-start p-3">
                        ...
                        <ul class="list-unstyled small">
                            <li class="mb-2 text-dark"><strong>Name:</strong> <?php echo $_SESSION['user_name'] ; ?></li>
                            <li class="mb-2 text-dark"><strong>Email:</strong> <?php echo $_SESSION['email'] ; ?></li>
                            <li class="mb-2 text-dark"><strong>Phone:</strong> <?php echo $_SESSION['phone'] ; ?></li>
                            <li class="mb-2 text-dark"><strong>Address:</strong> <?php echo $_SESSION['address'] ; ?></li>
                            <li class="text-dark"><strong>Joined:</strong> <?php echo $_SESSION['created_at'] ; ?></li>
                        </ul>
                    </div>
                </div>
            </div>

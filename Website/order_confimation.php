    ...
    <main class="row g-4">
        ...
        <div class="col-lg-8">
                ...
                <ul class="list-group list-group-flush mb-4">
                    <li class="list-group-item d-flex justify-content-between align-items-center p-0 py-3">
                        <div class="d-flex align-items-center gap-3">
                            <img src="../Admin/assets/uploads/<?php echo $row['product_image']; ?>" alt="<?php echo $row['product_name']; ?> Image" class="rounded-3 border" style="width:60px; height:80px; object-fit:cover;">
                            <div>
                                <p class="fw-semibold text-dark mb-0"><?php echo $row['product_name']; ?></p>
                                <small class="text-secondary">Product Details Here</small> 
                                <span class="badge badge-featured mt-1">Status: <?php echo $row['order_status']; ?></span>
                            </div>
                        </div>
            ...
            <div class="mt-4 d-grid gap-3 d-sm-flex">
                <a href="track-order.php?id=<?php echo $row['order_id']; ?>" class="btn btn-danger btn-lg fw-semibold shadow-sm flex-fill">Track My Order</a>
                <div class="m-2"></div>
                <a href="index.php" class="btn btn-outline-danger btn-lg fw-semibold shadow-sm flex-fill">Continue Shopping</a>
            </div>
        </div>

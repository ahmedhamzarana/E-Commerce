                    ...
                    <div class="card-body p-3">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="proeditname"
                            ...
                            <div class="form-group">
                                <label>Price</label>
                                <input type="number" class="form-control" name="proeditprice"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="proeditcategory" required>
                                    ...
                                    <option <?php if ($row['category'] == "Cosmetics")
                                        echo "selected"; ?>>Cosmetics
                                    </option>
                                    <option <?php if ($row['category'] == "Jewellery")
                                        echo "selected"; ?>>Jewellery
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="proeditdesc"
                            ...
                            <div class="form-group">
                                <label>Stock</label>
                                <input type="number" class="form-control" name="proeditstock"

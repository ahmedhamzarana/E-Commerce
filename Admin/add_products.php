        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $row['id']; ?></td>
                        <td><img src="assets/uploads/<?= $row['image'] ?>" width="50" class="rounded"></td>
                        <td><?= $row['name']; ?></td>
                        <td><?= $row['price']; ?></td>
                        <td><?= $row['category']; ?></td>
                      ...
                      <td>
                          <div class="row">
                            ...
                            <div class="m-2"></div>
                              <a href="delete_product.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Delete</a>
                          </div>
                      </td>
                    </tr>
                    <?php endforeach; ?>
    ...
    <div class="card card-hero">
        ...
        <div class="card-body p-3">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button class="btn btn-primary btn-block" type="submit" name="addproduct">Add Product</button>

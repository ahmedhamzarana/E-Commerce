            ...
            <ul class="navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        <img alt="image" src="assets/uploads/<?php echo $_SESSION['image']; ?>" class="rounded-circle mr-1">
                        <div class="d-sm-none d-lg-inline-block">Welcome, <?php echo $_SESSION['user_name']; ?> </div>
                    </a>
